...
![Azure Bastion RDP architecture](../assets/diagrams/bastion-rdp.svg)

## Overview
A private Windows VM reachable through Azure Bastion.
...
| Item | Description |
|---|---|
| Main topic | Bastion subnet, Bastion host, and private RDP |
| Azure scope | One resource group tagged for this lesson |
| Default region | `eastus2` |
| Naming style | `clz-dev-clz210-*` |
| Cleanup path | `terraform destroy` from this folder |

## Learning Outcomes
Create AzureBastionSubnet; remove public VM access; use browser-based RDP.
...
| `bastion.tf` | Lesson-specific Azure resources |
...
- Resource names start with `clz-dev-clz210`.
...
## Next Lesson
Put multiple Windows web nodes behind a load balancer.
