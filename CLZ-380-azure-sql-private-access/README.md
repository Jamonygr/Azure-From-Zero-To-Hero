# CLZ-380 - Azure SQL Private Access

![Azure SQL Private Access architecture](../assets/diagrams/private-endpoint-sql.svg)
...
## Learning Outcomes
Disable public access; create SQL private DNS; connect the private endpoint.
...
| `azure-sql.tf` | Lesson-specific Azure resources |
...
- Resource names start with `clz-dev-clz380`.
...
## Next Lesson
Combine the patterns in the capstone.
