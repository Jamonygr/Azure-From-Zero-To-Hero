...
![Final Windows Reference Architecture architecture](../assets/diagrams/capstone-architecture.svg)

## Overview
A reusable Windows reference architecture using local modules.
...
| Item | Description |
|---|---|
| Main topic | Modules, VMSS, Bastion, Key Vault, and monitoring |
...
| `capstone.tf` | Lesson-specific Azure resources |
...
- Resource names start with `clz-dev-clz390`.
