# CLZ-200 - Windows VM IIS Bootstrap

![Windows VM IIS Bootstrap architecture](../assets/diagrams/windows-iis-vm.svg)

## Overview
A Windows Server web node with IIS and a custom validation page.
...
| Item | Description |
|---|---|
| Main topic | IIS with PowerShell Custom Script Extension |
| Azure scope | One resource group tagged for this lesson |
| Default region | `eastus2` |
| Naming style | `clz-dev-clz200-*` |
| Cleanup path | `terraform destroy` from this folder |

## Learning Outcomes
Use Custom Script Extension; publish a simple page; validate through HTTP.
...
- Resource names start with `clz-dev-clz200`.
...
## Next Lesson
Move administration behind Azure Bastion.
