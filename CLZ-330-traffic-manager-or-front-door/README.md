# CLZ-330 - Traffic Manager Or Front Door

![Traffic Manager Or Front Door architecture](../assets/diagrams/global-routing.svg)

## Overview
A global routing profile over configurable endpoint host names.
...
## Learning Outcomes
Understand priority routing; configure endpoint monitoring; plan global failover.
...
| `traffic-manager.tf` | Lesson-specific Azure resources |
...
- Resource names start with `clz-dev-clz330`.
...
## Next Lesson
Move generated secrets into Key Vault.
