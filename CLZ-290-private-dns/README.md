...
![Private DNS architecture](../assets/diagrams/private-endpoint-sql.svg)

## Overview
An internal DNS zone linked to the lab VNet.
...
| Item | Description |
|---|---|
| Main topic | Private DNS zones and internal names |
| Azure scope | One resource group tagged for this lesson |
| Default region | `eastus2` |
| Naming style | `clz-dev-clz290-*` |
| Cleanup path | `terraform destroy` from this folder |

## Learning Outcomes
Create a private zone; link it to a VNet; add a private A record.
...
| `private-dns.tf` | Lesson-specific Azure resources |
...
- Resource names start with `clz-dev-clz290`.
