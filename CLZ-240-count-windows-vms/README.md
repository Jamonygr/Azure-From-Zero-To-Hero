# CLZ-240 - Count Windows VMs

![Count Windows VMs architecture](../assets/diagrams/windows-iis-vm.svg)

## Overview
A small set of identical Windows VMs created from a count value.
...
## Learning Outcomes
Use count.index; produce list outputs; understand when count is appropriate.
...
| `compute-count.tf` | Lesson-specific Azure resources |
...
- Resource names start with `clz-dev-clz240`.
...
## Next Lesson
Create named VMs with for_each.
