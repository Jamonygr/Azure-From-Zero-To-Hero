...
![Windows VMSS Autoscaling architecture](../assets/diagrams/load-balancer-vmss.svg)

## Overview
A Windows VMSS with CPU-based scale-out and scale-in rules.
...
| Item | Description |
|---|---|
| Main topic | Autoscale rules and validation |
...
- Resource names start with `clz-dev-clz270`.
