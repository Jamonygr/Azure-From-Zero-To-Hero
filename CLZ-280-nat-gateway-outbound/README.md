# CLZ-280 - NAT Gateway Outbound

![NAT Gateway Outbound architecture](../assets/diagrams/network-foundation.svg)

## Overview
A subnet with stable outbound access through NAT Gateway.
...
| Item | Description |
|---|---|
| Main topic | NAT Gateway for private Windows workloads |
| Azure scope | One resource group tagged for this lesson |
| Default region | `eastus2` |
| Naming style | `clz-dev-clz280-*` |
...
## Learning Outcomes
Attach a NAT Gateway; understand egress identity; keep inbound access separate.
...
| `nat-gateway.tf` | Lesson-specific Azure resources |
...
- Resource names start with `clz-dev-clz280`.
